 ...
 * @extends {ActorSheet}
 */
export class HvpunofficialActorSheet extends ActorSheet {

  /** @override */
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      classes: ["hvpunofficial", "sheet", "actor"],
      template: "systems/hvpunofficial/templates/actor/actor-sheet.html",
      width: 600,
      height: 600,
