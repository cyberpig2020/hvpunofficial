 ...
 * @type {Object}
 */
 BOILERPLATE.mainParameters = {
    "bodyBuild": "HVPUNOFFICIAL.MainParametersBodyBuild",
    "dexterity": "HVPUNOFFICIAL.MainParametersDexterity",
    "perception": "HVPUNOFFICIAL.MainParametersPerception",
    "intelligence": "HVPUNOFFICIAL.MainParametersIntelligence",
    "cool": "HVPUNOFFICIAL.MainParametersCool",
